...
interface TargetSummaryCardsProps {
  targetListLength: number;
  summaries: TargetSummaryItem[];
}

export default function TargetSummaryCards({ targetListLength, summaries }: TargetSummaryCardsProps) {
  if (targetListLength === 0) return null;
