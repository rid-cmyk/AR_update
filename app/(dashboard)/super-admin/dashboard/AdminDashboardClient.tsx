...
import { SystemStatus } from '@/components/super-admin/dashboard/SystemStatus'
...
export default function AdminDashboardClient({ data, embedded = false }: { data: DashboardStats; embedded?: boolean }) {
    ...
    <div className={styles.container}>
      {embedded ? (
        <div className={styles.sectionHeader} style={{ marginBottom: 16 }}>
          <div>
            <Title level={3} className={styles.sectionTitle}>Dashboard Admin</Title>
            <Text type="secondary">Ringkasan operasional dan pengelolaan sistem</Text>
          </div>
          <Link href="/super-admin/template-ujian">
      ...
      <div className={styles.section}>
        <QuickActions userRole="super_admin" />
      </div>
      ...
      <Row gutter={[12, 12]} className={styles.section}>
        <Col xs={12} sm={12} lg={6}>
          <Card
            ...
            styles={{ body: {} }}
            onClick={() => router.push("/super-admin/template-ujian")}
          >
        ...
        <Col xs={12} sm={12} lg={6}>
          <Card
            ...
            styles={{ body: {} }}
            onClick={() => router.push("/super-admin/halaqah")}
          >
            <Space direction="vertical" size={12} className={styles.cardInnerSpace}>
              <div className={styles.cardHeader}>
