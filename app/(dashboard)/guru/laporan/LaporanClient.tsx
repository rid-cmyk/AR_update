...
interface LaporanClientProps {
  initialStats: {
    totalUjian: number;
    rataRataNilai: number | string;
    totalSantri: number;
    hafalanRate: number;
  }
}

export default function LaporanClient({ initialStats }: LaporanClientProps) {
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-600">{initialStats.totalUjian}</p>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">{initialStats.rataRataNilai}</p>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-purple-600">{initialStats.totalSantri}</p>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-orange-600">{initialStats.hafalanRate}%</p>
