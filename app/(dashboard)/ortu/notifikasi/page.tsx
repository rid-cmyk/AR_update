          ...
          <Row gutter={[16, 16]} align="middle">
            ...
            <Col xs={24} md={12} style={{ textAlign: 'center' }}>
              <Space size="small" wrap>
                <span style={{ fontWeight: 'bold', color: '#722ED1', fontSize: '14px' }}>📋 Status:</span>
                <Button
            ...
            <Col xs={24} md={12} style={{ textAlign: 'center' }}>
              <Space size="small" wrap>
                <span style={{ fontWeight: 'bold', color: '#722ED1', fontSize: '14px' }}>🏷️ Kategori:</span>
                <Button
                ...
                <Button
                  type={filterTipe === 'jadwal' ? 'primary' : 'default'}
                  size="small"
                  onClick={() => setFilterTipe('jadwal')}
                  style={{ borderRadius: '20px' }}
