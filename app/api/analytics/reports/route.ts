...
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await AnalyticsService.getReports(searchParams.get('startDate'), searchParams.get('endDate'));
    ...
    return ApiResponse.serverError('Gagal mengambil data laporan analytics')
  }
}
