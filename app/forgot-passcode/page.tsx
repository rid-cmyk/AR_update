...
import { FloatingHelpButton } from "@/components/forgot-passcode/FloatingHelpButton";
import { AdminHelpModal } from "@/components/forgot-passcode/AdminHelpModal";
  ...
  if (submitted && response) {
    return (
      <div className="forgot-passcode-container">
        ...
        {adminSettings && (
          <FloatingHelpButton onClick={() => setHelpModalVisible(true)} />
        )}
        ...
        {/* Help Modal */}
        <AdminHelpModal visible={helpModalVisible} onCancel={() => setHelpModalVisible(false)} adminSettings={adminSettings} />
      </div>
    );
  }
    ...
    <div className="forgot-passcode-container">
      ...
      <Card className="forgot-card">
        <div style={{ textAlign: 'center', marginBottom: 24 }}>
          <h2 style={{ color: '#219ebc', marginBottom: 8 }}>
            🔐 Lupa Passcode?
          </h2>
