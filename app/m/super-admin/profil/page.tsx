    ...
    <div className="min-h-[calc(100vh-8rem)] bg-[#f4f9fb] p-4 space-y-6 pb-24">
      ...
      <div className="bg-gradient-to-br from-sky-blue via-blue-green to-deep-space border border-slate-200/80 rounded-3xl p-5 flex items-center gap-4 shadow-sm">
        ...
        <div className="min-w-0">
          ...
          <p className="text-xs text-white/80 truncate">@{user?.username || "superadmin"}</p>
        </div>
      </div>
      ...
      <MobileCard className="space-y-3">
        ...
        <div className="flex items-center justify-between p-3 bg-sky-blue/10 rounded-xl">
          <div className="flex items-center gap-3">
            <CrownOutlined className="text-blue-green text-lg" />
            <span className="text-sm font-medium text-deep-space">Akses Root / Sistem Penuh</span>
          </div>
        ...
        <div className="flex items-center justify-between p-3 bg-sky-blue/10 rounded-xl">
          <div className="flex items-center gap-3">
            <KeyOutlined className="text-blue-green text-lg" />
            <span className="text-sm font-medium text-deep-space">Reset & Kelola Passcode</span>
          </div>
