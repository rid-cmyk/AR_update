...
export default function MobileSuperAdminDashboard() {
  ...
  return (
    <div className="p-4 space-y-6">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-700 via-purple-800 to-slate-900 p-6 shadow-lg border border-indigo-400/20">
        <div className="relative z-10">
          <span className="inline-block px-3 py-1 rounded-full bg-white/15 backdrop-blur-md text-indigo-100 text-[11px] font-semibold mb-2">
            Super Admin Control Center
          </span>
          <h2 className="text-2xl font-bold text-white mb-1">
            Kontrol Penuh Sistem
          </h2>
          <p className="text-indigo-100 text-xs max-w-xs leading-relaxed opacity-90 mb-4">
            Kelola seluruh akun pengguna, notifikasi passcode, dan backup basis data.
          </p>

          <div className="flex items-center gap-2">
            <Link href="/m/super-admin/users">
              <button className="bg-white text-indigo-900 hover:bg-indigo-50 font-semibold rounded-full h-9 px-4 text-xs shadow-md transition-all tap-active flex items-center gap-1.5">
                <TeamOutlined />
        ...
        <div className="absolute -right-10 -bottom-10 w-48 h-48 rounded-full bg-indigo-400/10 blur-2xl pointer-events-none" />
      </div>
      ...
      <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-4 space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          >
            <TeamOutlined className="text-indigo-400 text-base" />
            <span>Manajemen User</span>
          </Link>

          <Link
            href="/super-admin/notifications/forgot-passcode"
            className="flex items-center gap-2 p-3 bg-slate-800/60 hover:bg-slate-800 border border-slate-700/50 rounded-xl text-slate-200 text-xs font-medium transition-all tap-active"
          >
          ...
          <Link
            href="/super-admin/settings/backup-database"
            className="flex items-center gap-2 p-3 bg-slate-800/60 hover:bg-slate-800 border border-slate-700/50 rounded-xl text-slate-200 text-xs font-medium transition-all tap-active"
          >
          ...
          <Link
            ...
            className="flex items-center gap-2 p-3 bg-slate-800/60 hover:bg-slate-800 border border-slate-700/50 rounded-xl text-slate-200 text-xs font-medium transition-all tap-active"
          >
            <SafetyCertificateOutlined className="text-sky-400 text-base" />
