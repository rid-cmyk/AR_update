                ...
                >
                  <Space direction="vertical" size="middle" style={{ width: '100%' }}>
                    ...
                    <div>
                      ...
                      <p style={{ margin: '8px 0', color: '#666', fontSize: '14px' }}>
                        Oversee all user accounts and roles
                      </p>
                    </div>
                    <div>
                ...
                >
                  <Space direction="vertical" size="small" style={{ width: '100%' }}>
                    <div>
                      ...
                      {dashboardData?.recentActivities?.announcements?.slice(0, 2).map((announcement, index) => (
                    ...
                    <div>
                      <strong>👥 Active Halaqah:</strong>
                      {dashboardData?.recentActivities?.halaqah?.slice(0, 3).map((halaqah, index) => (
                        <div key={index} style={{ margin: '4px 0', fontSize: '14px', color: '#666' }}>
                          {halaqah.namaHalaqah} ({halaqah.santriCount} santri)
                        </div>
                      ))}
                    </div>
                  </Space>
